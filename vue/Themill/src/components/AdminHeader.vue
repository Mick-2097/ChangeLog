<template>
<div class="navbar px-5 justify-content-center justify-content-md-between" style="background-color: rgba(0, 0, 0, 0.1);">

    <!-- Logo -->
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="210.000000pt" height="43.500000pt" viewBox="0 0 700.000000 145.000000" preserveAspectRatio="xMidYMid meet">
        <metadata>
        </metadata>
    ...
    <!-- nav links -->
    <div class="btn-group d-flex flex-wrap justify-content-center" role="group" aria-label="Nav links">
        <a class="nav-link"><RouterLink to="/">Home</RouterLink></a>
        <a class="nav-link"><RouterLink to="/groups">Groups</RouterLink></a>
        <a class="nav-link"><RouterLink to="/editor">Editor</RouterLink></a>
        <a class="nav-link"><RouterLink to="/adminhome">Admin home</RouterLink></a>
    </div>
